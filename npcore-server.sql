...
-- Dumping database structure for npcore
CREATE DATABASE IF NOT EXISTS `npcore` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
USE `npcore`;

-- Dumping structure for table npcore.characters
...
-- Dumping data for table npcore.characters: ~0 rows (approximately)
DELETE FROM `characters`;
/*!40000 ALTER TABLE `characters` DISABLE KEYS */;
/*!40000 ALTER TABLE `characters` ENABLE KEYS */;

-- Dumping structure for table npcore.characters_cars
...
-- Dumping data for table npcore.characters_cars: ~0 rows (approximately)
DELETE FROM `characters_cars`;
/*!40000 ALTER TABLE `characters_cars` DISABLE KEYS */;
/*!40000 ALTER TABLE `characters_cars` ENABLE KEYS */;

-- Dumping structure for table npcore.characters_weapons
...
-- Dumping data for table npcore.characters_weapons: ~0 rows (approximately)
...
-- Dumping structure for table npcore.character_current
...
-- Dumping data for table npcore.character_current: ~0 rows (approximately)
...
-- Dumping structure for table npcore.character_face
...
-- Dumping data for table npcore.character_face: ~0 rows (approximately)
DELETE FROM `character_face`;
/*!40000 ALTER TABLE `character_face` DISABLE KEYS */;
/*!40000 ALTER TABLE `character_face` ENABLE KEYS */;

-- Dumping structure for table npcore.character_outfits
...
-- Dumping data for table npcore.character_outfits: ~0 rows (approximately)
...
-- Dumping structure for table npcore.character_passes
...
-- Dumping data for table npcore.character_passes: ~0 rows (approximately)
...
-- Dumping structure for table npcore.delivery_job
...
-- Dumping data for table npcore.delivery_job: ~30 rows (approximately)
...
-- Dumping structure for table npcore.exploiters
...
-- Dumping data for table npcore.exploiters: ~0 rows (approximately)
DELETE FROM `exploiters`;
/*!40000 ALTER TABLE `exploiters` DISABLE KEYS */;
/*!40000 ALTER TABLE `exploiters` ENABLE KEYS */;

-- Dumping structure for table npcore.fine_types
...
-- Dumping data for table npcore.fine_types: ~143 rows (approximately)
...
-- Dumping structure for table npcore.group_banking
CREATE TABLE IF NOT EXISTS `group_banking` (
  `group_type` mediumtext DEFAULT NULL,
  `bank` int(11) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Dumping data for table npcore.group_banking: ~11 rows (approximately)
...
-- Dumping structure for table npcore.jobs_whitelist
...
-- Dumping data for table npcore.logs: ~0 rows (approximately)
DELETE FROM `logs`;
/*!40000 ALTER TABLE `logs` DISABLE KEYS */;
/*!40000 ALTER TABLE `logs` ENABLE KEYS */;

-- Dumping structure for table npcore.mdt_reports
...
-- Dumping data for table npcore.mdt_reports: ~0 rows (approximately)
DELETE FROM `mdt_reports`;
/*!40000 ALTER TABLE `mdt_reports` DISABLE KEYS */;
/*!40000 ALTER TABLE `mdt_reports` ENABLE KEYS */;

-- Dumping structure for table npcore.mdt_warrants
...
-- Dumping data for table npcore.mdt_warrants: ~0 rows (approximately)
DELETE FROM `mdt_warrants`;
/*!40000 ALTER TABLE `mdt_warrants` DISABLE KEYS */;
/*!40000 ALTER TABLE `mdt_warrants` ENABLE KEYS */;

-- Dumping structure for table npcore.mech_materials
...
-- Dumping data for table npcore.mech_materials: ~4 rows (approximately)
...
-- Dumping structure for table npcore.modded_cars
...
-- Dumping data for table npcore.tweets: ~0 rows (approximately)
DELETE FROM `tweets`;
/*!40000 ALTER TABLE `tweets` DISABLE KEYS */;
/*!40000 ALTER TABLE `tweets` ENABLE KEYS */;

-- Dumping structure for table npcore.users
...
-- Dumping data for table npcore.users: ~0 rows (approximately)
DELETE FROM `users`;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
/*!40000 ALTER TABLE `users` ENABLE KEYS */;

-- Dumping structure for table npcore.user_contacts
...
-- Dumping data for table npcore.user_contacts: ~0 rows (approximately)
DELETE FROM `user_contacts`;
/*!40000 ALTER TABLE `user_contacts` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_contacts` ENABLE KEYS */;

-- Dumping structure for table npcore.user_convictions
...
-- Dumping data for table npcore.user_convictions: ~0 rows (approximately)
...
-- Dumping structure for table npcore.user_inventory2
...
-- Dumping data for table npcore.user_licenses: ~0 rows (approximately)
DELETE FROM `user_licenses`;
/*!40000 ALTER TABLE `user_licenses` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_licenses` ENABLE KEYS */;

-- Dumping structure for table npcore.user_mdt
...
-- Dumping data for table npcore.user_mdt: ~0 rows (approximately)
DELETE FROM `user_mdt`;
/*!40000 ALTER TABLE `user_mdt` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_mdt` ENABLE KEYS */;

-- Dumping structure for table npcore.user_messages
...
-- Dumping data for table npcore.user_messages: 0 rows
DELETE FROM `user_messages`;
/*!40000 ALTER TABLE `user_messages` DISABLE KEYS */;
/*!40000 ALTER TABLE `user_messages` ENABLE KEYS */;

-- Dumping structure for table npcore.vehicle_display
...
-- Dumping data for table npcore.vehicle_display: ~9 rows (approximately)
...
-- Dumping structure for table npcore.vehicle_mdt
...
-- Dumping data for table npcore.weed: ~0 rows (approximately)
DELETE FROM `weed`;
/*!40000 ALTER TABLE `weed` DISABLE KEYS */;
/*!40000 ALTER TABLE `weed` ENABLE KEYS */;

-- Dumping structure for table npcore.__banking_logs
...
-- Dumping data for table npcore.__housedata: ~0 rows (approximately)
DELETE FROM `__housedata`;
/*!40000 ALTER TABLE `__housedata` DISABLE KEYS */;
/*!40000 ALTER TABLE `__housedata` ENABLE KEYS */;

-- Dumping structure for table npcore.__housekeys
...
-- Dumping data for table npcore.__motels: ~0 rows (approximately)
