local blips = {
    ...
    {id = "Bennys", name = "Bennys Motor Works", scale = 0.5, color = 1, sprite = 72, x=-212.28814697266, y=-1324.95703125, z=30.890},
    {id = "Auto Exotics", name = "Auto Exotics", scale = 0.5, color = 1, sprite = 72, x=535.5615234375, y=-179.61291503906, z=54.364429473877},
    {id = "Auto Bodies", name = "Auto Bodies", scale = 0.5, color = 1, sprite = 72, x=-1417.1550292969, y=-446.43911743164, z=35.909713745117},
    {id = "Tuner Shop", name = "Tuner Shop", scale = 0.5, color = 1, sprite = 72, x=937.23828125, y=-970.89343261719, z=39.543106079102},
    ...
    {id = "weazel", name = "Weazel News", scale = 0.5, color = 6, sprite = 47, x = -598.248046875, y= -929.77307128906, z= 23.869129180908},
    {id = "beanmachine", name = "Bean Machine", scale = 0.5, color = 44, sprite = 106, x = -629.541015625, y= 233.69226074219, z= 81.881462097168},
    {id = "bestbuds", name = "BestBuds", scale = 0.5, color = 61, sprite = 140, x = -622.3955078125, y= -297.32778930664, z= 35.341938018799},
}
