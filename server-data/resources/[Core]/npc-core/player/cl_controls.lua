...
function NPC.DataControls.setBindTable(controlTable,shouldSend)
	if controlTable == nil then
		...
		TriggerServerEvent('npc-core:sv:player_control_set',NPC.Controls.Current)
...
RegisterNetEvent("npc-core:cl:player_control")
AddEventHandler("npc-core:cl:player_control", function(controlTable)
...
RegisterNetEvent('npc-core:setcontrols')
AddEventHandler('npc-core:setcontrols', function()
	TriggerServerEvent('npc-core:sv:player_controls')
end)