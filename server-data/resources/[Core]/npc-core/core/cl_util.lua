...
function NPC.Util.RotationToDirection(self,rotation)
...
function NPC.Util.ScreenRelToWorld(self,camPos,camRot,coord)

      local distance = 1000.0
      local camForward = NPC.Util.RotationToDirection(self,camRot);
      ...
      local camRight = NPC.Util.RotationToDirection(self,rotRight) - NPC.Util.RotationToDirection(self,rotLeft);
      local camUp = NPC.Util.RotationToDirection(self,rotUp) - NPC.Util.RotationToDirection(self,rotDown);
