...
RegisterNetEvent('npc-banking:updateBalance')
AddEventHandler('npc-banking:updateBalance', function(balance, show)
	SendNUIMessage({
		updateBalance = true,
		balance = balance,
    name = "",
...
RegisterNetEvent('npc-banking:updateCash')
AddEventHandler('npc-banking:updateCash', function(balance, show)
  local id = PlayerId()
...
RegisterNetEvent("npc-banking:viewBalance")
AddEventHandler("npc-banking:viewBalance", function()
  SendNUIMessage({
    viewBalance = true
  })
end)
...
RegisterNetEvent("npc-banking:addBalance")
AddEventHandler("npc-banking:addBalance", function(amount)
	SendNUIMessage({
		addBalance = true,
		amount = amount
	})
...
RegisterNetEvent("npc-banking:removeBalance")
AddEventHandler("npc-banking:removeBalance", function(amount)
	SendNUIMessage({
		removeBalance = true,
		amount = amount
	})
...
RegisterNetEvent("npc-banking:addCash")
AddEventHandler("npc-banking:addCash", function(amount)
	SendNUIMessage({
		addCash = true,
		amount = amount
	})
...
RegisterNetEvent("npc-banking:removeCash")
AddEventHandler("npc-banking:removeCash", function(amount)
	SendNUIMessage({
		removeCash = true,
		amount = amount
	})
...
RegisterNetEvent("npc-banking:transfer:getlogs")
AddEventHandler("npc-banking:transfer:getlogs", function()
