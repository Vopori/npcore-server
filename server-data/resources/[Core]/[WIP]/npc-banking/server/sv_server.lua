...
local STEAM_KEY = "FDB3A26243DB74BAD428E2E206C6C330"
local DISCORD_IMAGE = "https://media.discordapp.net/attachments/851633925624168479/851634078243094558/NPCore_Base_GH.png" -- Default is NPCore logo.
...
AddEventHandler("bank:get:balance", function()
  ...
  Citizen.Wait(2000)
  TriggerClientEvent("npc-banking:updateBalance", src, char.bank)
  TriggerClientEvent('npc-banking:updateCash', src, char.cash)
  TriggerClientEvent("bank:getbankAccountNumber", src, char.id)
end)
