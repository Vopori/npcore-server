...
RegisterNetEvent('npc-radio:resetNuiCommand')
AddEventHandler('npc-radio:resetNuiCommand', function()
...
function hasRadio()
  return exports["npc-inventory"]:hasEnoughOfItem("radio", 1, false)
end
...
RegisterNUICallback('volumeUp', function(data, cb)
  if vol < 100 then
    vol = vol + 10
    TriggerEvent("npc-voice:SetRadioVolume", vol)
...
RegisterNUICallback('poweredOn', function(data, cb)
  ...
  exports['npc-voice']:addPlayerToRadio(fuckingidiot)
  exports["npc-voice"]:setVoiceProperty("radioEnabled", true)
end)
...
RegisterNUICallback('poweredOff', function(data, cb)
  ...
  exports['npc-voice']:removePlayerFromRadio()
  exports["npc-voice"]:setVoiceProperty("radioEnabled", false)
end)
...
RegisterNUICallback('close', function(data, cb)
  ...
  if fuckingidiot == 0 then
    ...
    exports['npc-voice']:addPlayerToRadio(radioChannel)
    exports["npc-voice"]:setVoiceProperty("radioEnabled", true)
  end
