...
exports["npc-polyzone"]:AddBoxZone("grovestreet", vector3(41.45, -1881.74, 22.46), 363.39999999999, 70, {
name="grove",
heading=48,
debugPoly=false,
minZ=0.91,
...
exports["npc-polyzone"]:AddBoxZone("Covenant", vector3(155.4, -1884.54, 23.58), 118.8, 40, {
name="Covenant",
heading=67,
debugPoly=false,
minZ=0.91,
...
exports["npc-polyzone"]:AddBoxZone("ForumDr", vector3(-84.32, -1557.19, 32.39), 350.4, 180, {
name="ForumDr",
heading=142,
debugPoly=false,
minZ=0.91,
...
exports["npc-polyzone"]:AddBoxZone("Brouge", vector3(251.47, -1738.92, 32.69), 122.4, 150, {
name="Brouge",
heading=140,
debugPoly=false,
minZ=0.91,
...
exports["npc-polyzone"]:AddBoxZone("Jamestown", vector3(404.07, -1894.42, 24.61), 450.0, 200, {
name="Jamestown",
heading=143,
debugPoly=false,
minZ=0.91,
...
exports["npc-polyzone"]:AddBoxZone("MirrorPark", vector3(1342.67, -562.5, 73.99), 140.0, 120, {
name="MirrorPark",
heading=70,
debugPoly=false,
minZ=100.59,
...
exports["npc-polyzone"]:AddBoxZone("Fudge", vector3(1335.86, -1611.34, 52.49), 400.4, 180, {
name="Fudge",
heading=125,
debugPoly=false,
minZ=90.49,
...
exports["npc-polyzone"]:AddBoxZone("Vespucci", vector3(-1113.7, -1601.84, 4.4), 200, 150, {
name="Vespucci",
heading=40,
debugPoly=false,
minZ=3.4,
...
exports["npc-polyzone"]:AddBoxZone("Cougar", vector3(-1497.17, -258.96, 50.36), 225.0, 150, {
name="Cougar",
heading=315,
debugPoly=false,
minZ=90.56,
...
exports["npc-polyzone"]:AddBoxZone("Harmony", vector3(850.29, 2692.07, 37.65), 1000, 250, {
name="Harmony",
heading=90,
debugPoly=false,
minZ=80.65,
...
Citizen.CreateThread(function()
    while true do 
       ...
       if IsPedShooting(PlayerPedId()) and IsAGang and NearGrove and not TargettingGrove and not AlreadyShot and not OnCooldown then
        ...
        print(AlreadyShot)
        print('lost rep')
        TriggerServerEvent('npc-territories:addrep', GetPlayerServerId(PlayerId()), -1)
