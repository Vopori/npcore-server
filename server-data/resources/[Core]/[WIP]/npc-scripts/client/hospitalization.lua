...
RegisterNetEvent("npc-hospitalization:checkin")
AddEventHandler("npc-hospitalization:checkin", function()
...
RegisterNetEvent("npc-hospitalization:page")
AddEventHandler("npc-hospitalization:page", function()
	if exports["isPed"]:isPed("countems") >= 1 then 
		loadAnimDict('anim@narcotics@trash')
		TaskPlayAnim(PlayerPedId(),'anim@narcotics@trash', 'drop_front',1.0, 1.0, -1, 1, 0, 0, 0, 0)
		local finished = exports["npc-taskbar"]:taskBar(1700,"Paging a Doctor")
		if finished == 100 then
