...
RegisterNUICallback('racing:events:list', function()
  if (exports["npc-inventory"]:hasEnoughOfItem("racingusb1", 1) or exports["npc-inventory"]:hasEnoughOfItem("racingusb0", 1, true)) then
      if exports["npc-inventory"]:hasEnoughOfItem("racingusb1", 1) then
          SendNUIMessage({
