...
AddEventHandler("npc-mdt:hotKeyOpen", function()
    TriggerServerEvent('npc-mdt:Open')
end)
...
RegisterNUICallback("getCalls", function(data, cb)
    TriggerServerEvent("npc-mdt:getCalls")
end)

RegisterNUICallback("attachToCall", function(data, cb)
    TriggerServerEvent("npc-mdt:attachToCall", data.index)
...
RegisterNUICallback("detachFromCall", function(data, cb)
    TriggerServerEvent("npc-mdt:detachFromCall", data.index)
    if callBlip then
        RemoveBlip(callBlip)
        callBlip = nil
    end
...
RegisterNUICallback("editCall", function(data, cb)
    TriggerServerEvent("npc-mdt:editCall", data.index, data.details)
    cb('ok')
end)

RegisterNUICallback("deleteCall", function(data, cb)
    TriggerServerEvent("npc-mdt:deleteCall", data.index)
    cb('ok')
end)
...
RegisterNetEvent("npc-mdt:getNewCallCoords")
AddEventHandler("npc-mdt:getNewCallCoords", function(details, callid)
    local coords = GetEntityCoords(PlayerPedId())
    TriggerServerEvent("npc-mdt:newCall", details, callid, coords)
end)

RegisterNetEvent("npc-mdt:newCall")
AddEventHandler("npc-mdt:newCall", function(details, callid, coords, index)
...
RegisterNetEvent("npc-mdt:newCallAttach")
AddEventHandler("npc-mdt:newCallAttach", function(index, charname)
    SendNUIMessage({
        type = "newCallAttach",
        call = index,
        charname = charname
...
RegisterNetEvent("npc-mdt:newCallDetach")
AddEventHandler("npc-mdt:newCallDetach", function(index, charname)
    SendNUIMessage({
        type = "newCallDetach",
        call = index,
        charname = charname
...
RegisterNetEvent("npc-mdt:editCall")
AddEventHandler("npc-mdt:editCall", function(index, details)
    SendNUIMessage({
        type = "editCall",
        call = index,
        details = details
...
RegisterNetEvent("npc-mdt:deleteCall")
AddEventHandler("npc-mdt:deleteCall", function(index)
    SendNUIMessage({
        type = "deleteCall",
        call = index
    })
...
RegisterCommand("mdt", function()
	if exports['isPed']:isPed('job') == 'Police' then
        TriggerEvent('npc-mdt:hotKeyOpen')
	end
