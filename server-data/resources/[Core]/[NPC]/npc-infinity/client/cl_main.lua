...
TriggerServerEvent("npc:infinity:player:ready")

RegisterNetEvent('npc:infinity:player:coords')
AddEventHandler('npc:infinity:player:coords', function (pCoords)
    PlayerCoords = pCoords
end)

RegisterNetEvent('npc:infinity:entity:coords')
AddEventHandler('npc:infinity:entity:coords', function (pNetId, pCoords)
...
function FetchEntityCoords(pNetId)
    ...
    TriggerServerEvent('npc:infinity:entity:coords', pNetId)
