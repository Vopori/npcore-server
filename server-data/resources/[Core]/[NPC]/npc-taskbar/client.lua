...
function closeGui()
    ...
    ClearPedTasks(PlayerPedId())
    TriggerEvent("npc-taskbar:disablecontrols", false)
end
...
function taskBar(length,name,runCheck,keepWeapon,vehicle,vehCheck)
    ...
    TriggerEvent("npc-taskbar:disablecontrols", true)
...
RegisterNetEvent('npc-taskbar:disablecontrols')
AddEventHandler('npc-taskbar:disablecontrols', function(status)
    pDisabled = status
