    ...
    methods: {
        changePage(page) {
            ...
            if (page == "Home") {
                ...
                $.post('https://npc-mdt-civ/getWarrants', JSON.stringify({}));
        ...
        closeMDT() {
            $.post('https://npc-mdt-civ/close', JSON.stringify({}));
        },
        OffenderSearch() {
            if (this.offender_search) {

                this.offender_results.query = this.offender_search;
                $.post('https://npc-mdt-civ/performOffenderSearch', JSON.stringify({
        ...
        OpenOffenderDetails(id) {
            for (var key in this.offender_results.results) {
                if (id == this.offender_results.results[key].id) {
                    ...
                    $.post('https://npc-mdt-civ/viewOffender', JSON.stringify({
        ...
        SaveOffenderChanges() {
            $.post('https://npc-mdt-civ/saveOffenderChanges', JSON.stringify({
        ...
        ReportSearch() {
            if (this.report_search) {
                ...
                $.post('https://npc-mdt-civ/performReportSearch', JSON.stringify({
        ...
        SubmitNewReport() {
            if (this.report_new.title && this.report_new.char_id && (Object.keys(this.report_new.charges).length > 0) && this.report_new.incident) {
                $.post('https://npc-mdt-civ/submitNewReport', JSON.stringify({
        ...
        OpenOffenderDetailsById(id) {
            $.post('https://npc-mdt-civ/getOffender', JSON.stringify({
                char_id: id
            }));
        ...
        DeleteSelectedReport() {
            $.post('https://npc-mdt-civ/deleteReport', JSON.stringify({
        ...
        SaveReportEditChanges() {
            $.post('https://npc-mdt-civ/saveReportChanges', JSON.stringify({
                id: this.report_selected.id,
        ...
        VehicleSearch() {
            if (this.vehicle_search) {
                ...
                $.post('https://npc-mdt-civ/vehicleSearch', JSON.stringify({
        ...
        OpenVehicleDetails(result) {
            $.post('https://npc-mdt-civ/getVehicle', JSON.stringify({
                vehicle: result
            }));
        ...
        SubmitNewWarrant() {
            ...
            $.post('https://npc-mdt-civ/submitNewWarrant', JSON.stringify({
        ...
        DeleteSelectedWarrant() {
            $.post('https://npc-mdt-civ/deleteWarrant', JSON.stringify({
        ...
        OpenReportById(id) {
            $.post('https://npc-mdt-civ/getReport', JSON.stringify({
                id: id
            }));
            return;
        },
        ...
        SentencePlayer() {
            ...
            $.post('https://npc-mdt-civ/sentencePlayer', JSON.stringify({
