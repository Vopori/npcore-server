    ...
    function()
        ...
        AddCircleZone(
            ...
            },
            {
                options = {
                    {
                        event = "npc-hospitalization:checkin",
                        icon = "far fa-clipboard",
                        label = "Check In"
                    }
                },
        ...
        AddBoxZone("burgershotcooker2 ", vector3(-1202.94, -897.38, 14.0), 1.7, 1, {
            ...
            options = {
                {
                    event = "npc-burgershot:startprocess3",
        ...
        AddBoxZone("burgershotfryer", vector3(-1202.01, -899.27, 14.0), 2.5, 1.5, {
            ...
            options = {
                {
                    event = "npc-burgershot:startfryer",
        ...
        AddBoxZone("burgershotself", vector3(-1199.54, -895.52, 14.0), 2.2, 0.6, {
            ...
            options = {
                {
                    event = "npc-burgershot:makeshake",
                    icon = "fas fa-hand-holding",
                    label = "Make a Nice Cold Mike Shake",

                },
                {
                    event = "npc-burgershot:getcola",
                    icon = "fas fa-hand-holding",
