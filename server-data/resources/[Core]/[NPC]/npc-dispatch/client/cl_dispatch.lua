...
RegisterNetEvent('npc-binds:keyEvent')
AddEventHandler('npc-binds:keyEvent', function(name,onDown)
...
AddEventHandler('police:panic', function()
      ...
      recipientList = {
		...
		TriggerEvent('npc-alerts:policepanic')
end)
...
AddEventHandler('police:assistance', function()
      ...
      recipientList = {
		...
		TriggerEvent('npc-alerts:assistanceneeded')
end)
...
AddEventHandler("police:1047", function()
    ...
    recipientList = {
      police = "police", ems = "ems"
		...
		TriggerEvent('npc-alerts:downguy')
end)
...
function AlertGunShot()
    Citizen.CreateThread(function() 
      ...
      TriggerEvent('npc-alerts:gunshot')
...
function AlertpersonRobbed(vehicle)
  ...
  TriggerEvent('npc-alerts:robstore')
...
function AlertCheckRobbery2()
  ...
  TriggerEvent('npc-alerts:robhouse')
  Wait(math.random(5000,15000))
...
function crypto()
  ...
  TriggerEvent('npc-alerts:cryptohack')
  Wait(math.random(5000,15000))
...
function AlertJewelRob()
  ...
  TriggerEvent('npc-alerts:jewrob')
  Wait(math.random(5000,15000))
...
function AlertMeth()
  ...
  TriggerEvent('npc-alerts:methexplosion')
...
function AlertUnionC4()
  ...
  TriggerEvent('npc-alerts:AlertUnionC4')
...
function AlertCoke()
  ...
  TriggerEvent('npc-alerts:AlertCoke')
...
function AlertPacific()
  ...
  TriggerEvent('npc-alerts:AlertPacific')
