...
rootMenuConfig =  {
    ...
    -- },
    {
        ...
        icon = "#cuffs",
        enableMenu = function()
            return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["npc-inventory"]:hasEnoughOfItem("cuffs",1,false)or (exports["npc-inventory"]:hasEnoughOfItem("key1",1,false))))
        end,
    ...
    },
    {
        ...
        enableMenu = function()
            return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["npc-inventory"]:hasEnoughOfItem("bag",1,false)))
        end
    },
    {
        id = "bagoff",
        ...
        enableMenu = function()
            return (not isDead and not isHandcuffed and not isHandcuffedAndWalking and (exports["npc-inventory"]:hasEnoughOfItem("bag",1,false) or isPolice or bagged))
        end
    },
    {
        id = "medic",
    ...
    },
    {
        ...
        displayName = "MDT",
        icon = "#mdt",
        functionName = "npc-mdt:hotKeyOpen",
        enableMenu = function()
...
newSubMenus = {
    ...
    ['blips:PD'] = {
        ...
        icon = "#police-action",
        functionName = "npc-spawnveh:showPD"
    },
    ['blips:EMS'] = {
        title = "Hospitals",
        icon = "#hospital-hospital",
        functionName = "npc-spawnveh:EMS"
    },
    ['blips:clothing'] = {
