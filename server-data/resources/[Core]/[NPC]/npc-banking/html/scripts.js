...
$(document).ready(function() {
    ...
    document.onkeyup = function(data) {
        if (data.which == 27) {
            $.post('https://npc-banking/close', JSON.stringify({}));
        }
    };
    // Handle Button Presses
    $(".btnWithdraw").click(function() {
        $.post('https://npc-banking/withdraw', JSON.stringify({}));
    });
    ...
    $("#Withdraw").click(function() {
        ...
        $.post('https://npc-banking/withdrawSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#Transfer").click(function() {
        ...
        $.post('https://npc-banking/transferSubmit', JSON.stringify({ toPlayer: playerid, amount: amount, reason: comment }));
        addlog(amount, comment, true)
    ...
    $("#Deposit").click(function() {
        ...
        $.post('https://npc-banking/depositSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#bussinessdepositaccept").click(function() {
        ...
        $.post('https://npc-banking/depositBussinessSubmit', JSON.stringify({ amount: amount, reason: comment }));
    ...
    $("#bussinessWithdrawaccept").click(function() {
        ...
        $.post('https://npc-banking/withdrawBussinessSubmit', JSON.stringify({ amount: amount, reason: comment }));
