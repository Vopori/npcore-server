...
RegisterServerEvent("npc-territories:approvedgang")
AddEventHandler("npc-territories:approvedgang", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
...
RegisterServerEvent("npc-territories:leader")
AddEventHandler("npc-territories:leader", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:grove")
AddEventHandler("npc-territories:grove", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:covenant")
AddEventHandler("npc-territories:covenant", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:brouge")
AddEventHandler("npc-territories:brouge", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:forum")
AddEventHandler("npc-territories:forum", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:jamestown")
AddEventHandler("npc-territories:jamestown", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:mirrorpark")
AddEventHandler("npc-territories:mirrorpark", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:fudge")
AddEventHandler("npc-territories:fudge", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:vespucci")
AddEventHandler("npc-territories:vespucci", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:cougar")
AddEventHandler("npc-territories:cougar", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:harmony")
AddEventHandler("npc-territories:harmony", function()
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local character = user:getCurrentCharacter()
...
RegisterServerEvent("npc-territories:addrep")
AddEventHandler("npc-territories:addrep", function(source, amount)
    local src = source
	local user = exports["npc-core"]:getModule("Player"):GetUser(src)
	local char = user:getCurrentCharacter()
    exports.ghmattimysql:execute('SELECT * FROM gangs WHERE `cid` = @cid', { ['@cid'] = char.id }, function(rep)
