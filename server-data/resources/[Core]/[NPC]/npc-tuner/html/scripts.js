$(document).ready(function(){
  ...
  $(".btntuneSystem").click(function(){
    console.log("h345elloooo")
      $.post('https://npc-tuner/tuneSystem', JSON.stringify({ boost: $("#boost").val(),fuel: $("#fuel").val(),gears: $("#gears").val(),braking: $("#braking").val(),drive: $("#drive").val()  }));
  });
  ...
  document.onkeyup = function (data) {
    if ( data.which == 27 ) {
      $.post('https://npc-tuner/close', JSON.stringify({}));
    }
  };
});
