...
AddEventHandler('npc-voice:settingsCallback', function(cb)
	cb(Cfg)
end)
...
RegisterCommand('+cycleproximity', function()
	...
	TriggerEvent('npc-voice:setTalkingMode', voiceMode)
	TriggerEvent("npc-hud:changeRange", voiceMode)
end, false)
RegisterCommand('-cycleproximity', function()
end)
RegisterKeyMapping('+cycleproximity', 'Cycle Proximity', 'keyboard', GetConvar('voice_defaultCycle', 'Z'))

RegisterNetEvent('npc-voice:mutePlayer', function()
...
function setVoiceProperty(type, value)
	...
	elseif type == "micClicks" then
		...
		micClicks = val
		SetResourceKvp('npc-voice_enableMicClicks', val)
	end
end
...
AddEventHandler('onClientResourceStart', function(resource)
	...
	local micClicksKvp = GetResourceKvpString('npc-voice_enableMicClicks')
	if not micClicksKvp then
		SetResourceKvp('npc-voice_enableMicClicks', tostring(true))
	else
