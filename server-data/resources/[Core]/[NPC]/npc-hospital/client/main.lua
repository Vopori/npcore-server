...
function LeaveBed()
    ...
    TriggerServerEvent('npc-hospital:server:LeaveBed', bedOccupying)
...
RegisterNetEvent('npc-hospital:client:RPCheckPos')
AddEventHandler('npc-hospital:client:RPCheckPos', function()
    TriggerServerEvent('npc-hospital:server:RPRequestBed', GetEntityCoords(PlayerPedId()))
end)

RegisterNetEvent('npc-hospital:client:RPSendToBed')
AddEventHandler('npc-hospital:client:RPSendToBed', function(id, data)
    bedOccupying = id
...
RegisterNetEvent('npc-hospital:client:SendToBed')
AddEventHandler('npc-hospital:client:SendToBed', function(id, data)
    bedOccupying = id
    bedOccupyingData = data
    ...
    Citizen.CreateThread(function ()
        ...
        TriggerServerEvent('npc-hospital:server:EnteredBed')
        TriggerEvent('npc-hospital:client:RemoveBleed')
    end)
end)

RegisterNetEvent('npc-hospital:client:FinishNancy')
AddEventHandler('npc-hospital:client:FinishNancy', function()
...
RegisterNetEvent('npc-hospital:client:FinishServices')
AddEventHandler('npc-hospital:client:FinishServices', function()
	SetEntityHealth(PlayerPedId(), GetEntityMaxHealth(PlayerPedId()))
    TriggerEvent('npc-hospital:client:RemoveBleed')
    TriggerEvent('npc-hospital:client:ResetLimbs')
    TriggerEvent('DoLongHudText', 'Treated.')
...
--                                 TriggerEvent('npc-hospital:client:FinishServices')
--                                 SetEntityHealth(PlayerPedId(), GetEntityMaxHealth(PlayerPedId()))
--                                 TriggerEvent('npc-hospital:client:RemoveBleed')
--                                 TriggerEvent('npc-hospital:client:ResetLimbs')
--                                 SetEntityHealth(PlayerPedId(), GetEntityMaxHealth(PlayerPedId()))
...
--                                 ClearPedTasks(PlayerPedId())
--                                 Citizen.Wait(1000)
--                                 TriggerServerEvent('npc-hospital:server:RequestBed')
--                             end
--                         else
